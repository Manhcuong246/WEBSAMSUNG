...
<html lang="en">
  ...
  <?php require_once "header.php" ?>
    <div class="container mt-5">
      ...
      foreach ($dangchoxacnhanadmin as $item) {
      ...
      ?>
       ...
       $tong += $item['gia_sanpham'] * $item['soluong_chitiet']; 
                  ...
                  <td class="tennguoi"><a href="?act=chitietuser&id=<?= $row['id_taikhoan_donhang'] ?>" style="color:white;"><?= $row['ten_taikhoan'] ?></a></td>
                    ...
                    <td>
                      <a onclick="return confirm('Cập nhật trạng thái thành Đang giao ? ')"   href="?act=xacnhangiaohang&id=<?= $row['id_donhang'] ?>" class="tm-product-delete-link">
