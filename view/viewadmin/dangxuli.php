      ...
      ?>
       ...
       $tong += $item['gia_sanpham'] * $item['soluong_chitiet']; 
                  ...
                  <td class="tm-product-name"><?= $row['id_donhang'] ?></td>
                    ...
                    <td>
                    <?php 
if ($row['trangthai_donhang'] == 'choxacnhan') {
    echo '<a onclick="return confirm(\'Hủy đơn hàng ?\')" href="?act=xoadonhang&id=' . $row['id_donhang'] . '" class="tm-product-delete-link">
