...
if (isset($_SESSION['vaitro']) && $_SESSION['vaitro'] == 'khachhang') {
    // Hiển thị phần tử nếu vaitro là 'khachhang'
    echo '<li class="nav-item dropdown">
            <a class="nav-link giohang" href="?act=giohang">
...
?>
    ...
    if (isset($_SESSION['login']) && $_SESSION['login'] == true) {
        if (isset($_SESSION['ten'])) {
            ...
            echo "<a class='dropdown-item' href='?act=admin'> <i class=' icon fa-solid fa-user'></i> &nbsp; "  . $_SESSION['ten'] . "</a>";
        } else {
